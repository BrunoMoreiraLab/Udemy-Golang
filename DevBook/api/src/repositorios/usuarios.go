...
//Criar insere um usuario de banco de dados
...
//Buscar traz um usuario do banco de dados
...
//BuscarPorEmail busca um usuario por email e retorna o seu ID e senha com o hash
